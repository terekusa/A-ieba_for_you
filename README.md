...
- 登録済みユーザー
  - 言えなかった言葉を贈るユーザー
    ...
    - 登録した自分の言えなかった言葉から画像合成しTwitterでシェアすることができる
    - 自分の贈った言葉が「どんな言葉で伝えれば良いか悩んでいるユーザー」とマッチングすると、誰にどんな場所でどんな言葉を伝えたかったのかのプロフィールと感謝のメッセージが贈られる
      - 自分の贈った言葉が「どんな言葉で伝えれば良いか悩んでいるユーザー」とマッチングすると、ActionCableによるアプリ内通知を受け取ることができる
  - どんな言葉で伝えれば良いか悩んでいるユーザー
    ...
    - 気に入った言葉があれば、誰かの言えなかった言葉とマッチングすることができ、そのユーザーへ感謝のメッセージを送ることができる
      - 誰かの言えなかった言葉を使ってどんな会話をすることができたのかを入力すると、その言葉が成仏できた画像を合成しTwitterでシェアすることができる
